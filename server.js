...
try{
  ...
  var empresas = "CREATE TABLE empresas (id INT AUTO_INCREMENT PRIMARY KEY, nome VARCHAR(255), senha VARCHAR(30), empresa VARCHAR(100), CNPJ INT(12), CEP INT(8), endereco VARCHAR(5), numero INT(3), telefone INT(9), email VARCHAR(255))"
